...
import static com.ivancom.mathematicstraining.MainActivity.HOMERUN_AWARE;
...
public class SubtrFunc extends Activity {
    ...
    String Questions;
    int choose=0, subtractionBasic=0, subtractionMedium=0, subtractionHigh=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtr_func);
        ...
        subtractionBasic = sharedata.getInt("subtractionBasic", 0);
        subtractionMedium = sharedata.getInt("subtractionMedium", 0);
        subtractionHigh = sharedata.getInt("subtractionHigh", 0);
        ...
        Log.d("SubtrFunc onCreate", "TODAY:"+ date_temp);
        Log.d("SubtrFunc onCreate", "subtractionBasic:"+sharedata.getInt("subtractionBasic",0));
        Log.d("SubtrFunc onCreate ", "subtractionMedium:"+sharedata.getInt("subtractionMedium",0));
        Log.d("SubtrFunc onCreate", "subtractionHigh:"+sharedata.getInt("subtractionHigh",0));

        Log.d("SubtrFunc onCreate", "stars:"+sharedata.getInt("stars",0));
        Log.d("SubtrFunc onCreate", "starHalf:"+sharedata.getBoolean("starHalf",false));
        Log.d("SubtrFunc onCreate", "errorCount:"+sharedata.getInt("errorCount",0));
        Log.d("SubtrFunc onCreate", "date:"+ sharedata.getString("date", "0"));
...
//                ETS7[i].setBackground(android.R.drawable.ic_lock_lock);
        ...
        IMGS2[0].setImageResource(R.drawable.subtraction);
        IMGS2[5].setImageResource(R.drawable.subtraction);

        IMGS6[0].setImageResource(R.drawable.subtraction);
        IMGS6[5].setImageResource(R.drawable.subtraction);
...
//Log.d("TEST", "我還要再算..........");
        ...
        if(GotoAgain == false) {
            Toast.makeText(SubtrFunc.this, "Please Check Your Answer In RED Fields Carefully", Toast.LENGTH_SHORT).show();
    ...
    void do_check()
    {
        ...
        if(GotoAgain==false)
        {
            MainActivity.screenShot(SubtrFunc.this);
            if(errorCount<3) {
    ...
    void Again2Test()
    {
        for(int i=0;i<4;i++) {
            switch (choose) {
                case 1:
                    ...
                    {
                        int tempInt = intArrayA[i];
                        intArrayA[i] =  intArrayB[i];
                        intArrayB[i]=tempInt;
                    }
                    break;
                case 2:
        ...
        switch (choose) {
            case 1:
                Log.d("TEST", "Again2Test... subtractionBasic:"+subtractionBasic);

                if(subtractionBasic==0) {
                    tvTitle.setText("初級減法 --ROUND 1--   　　　　　  " + s);
                }
                else
                {
                    tvTitle.setText("初級減法 --ROUND 2--   　　　　　  " + s);
                }
            ...
            case 2:
                ...
                if(subtractionMedium==0) {
                    tvTitle.setText("中級減法 --ROUND 1--   　　　　　  " + s);
                }
                else
                {
                    tvTitle.setText("中級減法 --ROUND 2--   　　　　　  " + s);
                }
                break;
            case 3:

                if(subtractionHigh==0) {
                    tvTitle.setText("高級減法 --ROUND 1--   　　　　　  " + s);
                }
                else
                {
                    tvTitle.setText("高級減法 --ROUND 2--   　　　　　  " + s);
                }
                break;
            default:
                break;
        }
        Questions = String.valueOf( intArrayA[0])+" - "+String.valueOf(intArrayB[0])+ " = ";
        tvQuestion1.setText(Questions);
        Questions = String.valueOf(intArrayA[1])+" - "+String.valueOf(intArrayB[1])+ " = ";
        tvQuestion2.setText(Questions);
        Questions = String.valueOf(intArrayA[2])+" - "+String.valueOf(intArrayB[2])+ " = ";
        tvQuestion3.setText(Questions);
        Questions = String.valueOf(intArrayA[3])+" - "+String.valueOf(intArrayB[3])+ " = ";
    ...
    protected void onResume() {
        ...
        Log.d("SubtrFunc onResume", "TODAY:"+ date_temp);
        Log.d("SubtrFunc onResume", "subtractionBasic:"+sharedata.getInt("subtractionBasic",0));
        Log.d("SubtrFunc onResume ", "subtractionMedium:"+sharedata.getInt("subtractionMedium",0));
        Log.d("SubtrFunc onResume", "subtractionHigh:"+sharedata.getInt("subtractionHigh",0));

        Log.d("SubtrFunc onResume", "stars:"+sharedata.getInt("stars",0));
        Log.d("SubtrFunc onResume", "starHalf:"+sharedata.getBoolean("starHalf",false));
        Log.d("SubtrFunc onResume", "errorCount:"+sharedata.getInt("errorCount",0));
        Log.d("SubtrFunc onResume", "date:"+ sharedata.getString("date", "0"));

        Log.d("homeRunCount onResume", "homeRunCount:"+ sharedata.getInt("homeRunCount", 0));
