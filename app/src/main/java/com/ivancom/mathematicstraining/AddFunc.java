...
public class AddFunc extends Activity {
    ...
    String Questions;
    int choose=0, addBasic=0, addMedium=0, addHigh=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBasic = sharedata.getInt("addBasic", 0);
        addMedium = sharedata.getInt("addMedium", 0);
        ...
        Log.d("AddFunc onCreate", "TODAY:"+ date_temp);
        Log.d("AddFunc onCreate", "addBasic:"+sharedata.getInt("addBasic",0));
        Log.d("AddFunc onCreate ", "addMedium:"+sharedata.getInt("addMedium",0));
        Log.d("AddFunc onCreate", "addHigh:"+sharedata.getInt("addHigh",0));

        Log.d("AddFunc onCreate", "stars:"+sharedata.getInt("stars",0));
        Log.d("AddFunc onCreate", "starHalf:"+sharedata.getBoolean("starHalf",false));
...
//                ETS7[i].setBackground(android.R.drawable.ic_lock_lock);
        ...
        IMGS2[0].setImageResource(R.drawable.addition);
        IMGS2[5].setImageResource(R.drawable.addition);

        IMGS6[0].setImageResource(R.drawable.addition);
        IMGS6[5].setImageResource(R.drawable.addition);
...
//Log.d("TEST", "我還要再算..........");
        ...
        if(GotoAgain == false) {
            Toast.makeText(AddFunc.this, "Please Check Your Answer In RED Fields Carefully", Toast.LENGTH_SHORT).show();
                    ...
                    if(addBasic == 2) {
                        if(MainActivity.HomeRunCheck(sharedata, true))
                        {
                            ...
                            AlertDialog dialog = new AlertDialog.Builder(this)
                                    ...
                                    .create();
                            dialog.show();
                            Log.d("TEST", "stars: Home Run Check After"+ sharedata.getInt("stars", 0));
                            editor.putInt("stars", stars);
                            editor.commit();
                        }
                        else{
    ...
    void Again2Test()
    {
        ...
        switch (choose) {
            case 1:
                Log.d("TEST", "Again2Test... addBasic:"+addBasic);
                //addBasic++;
                if(addBasic==0) {
                    tvTitle.setText("初級加法 --ROUND 1--   　　　　　  " + s);
                }
                else
                {
                    tvTitle.setText("初級加法 --ROUND 2--   　　　　　  " + s);
                }
            ...
            case 2:
               // addMedium++;
                if(addMedium==0) {
                    tvTitle.setText("中級加法 --ROUND 1--   　　　　　  " + s);
                }
                else
                {
                    tvTitle.setText("中級加法 --ROUND 2--   　　　　　  " + s);
                }
                break;
            case 3:
              // addHigh++;
                if(addHigh==0) {
                    tvTitle.setText("高級加法 --ROUND 1--   　　　　　  " + s);
                }
                else
                {
                    tvTitle.setText("高級加法 --ROUND 2--   　　　　　  " + s);
                }
                break;
            default:
                break;
    ...
    protected void onResume() {
        ...
        Log.d("AddFunc onCreate", "TODAY:"+ date_temp);
        Log.d("AddFunc onResume", "addBasic:"+sharedata.getInt("addBasic",0));
        Log.d("AddFunc onResume ", "addMedium:"+sharedata.getInt("addMedium",0));
        Log.d("AddFunc onResume", "addHigh:"+sharedata.getInt("addHigh",0));
